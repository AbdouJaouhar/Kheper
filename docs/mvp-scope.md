...
| G3 | Productive skill | MVP | All 24 uniliteral signs support reviewed, tolerant, explainable construction feedback. |
...
| Hieratic, Demotic, Coptic, cryptographic, or Ptolemaic specialist writing | Excluded | Monumental Middle Egyptian hieroglyphs only. |
...
| --- | --- | --- |
| Orientation; 24 uniliterals; approximately 30 words; approximately 40 lessons | MVP | Complete English foundational course packaged with the application. |
