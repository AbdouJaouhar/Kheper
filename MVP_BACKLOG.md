...
| KHEPER-036 | Blocked | Task | P0 | Create cross-platform application foundation | A minimal iOS/Android application builds from one codebase on supported toolchains and displays embedded content without runtime connectivity. | KHEPER-002, KHEPER-004 |
